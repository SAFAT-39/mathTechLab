...
const Card: React.FC<CardProps> = ({ title, link, bgColor }) => {
  return (
    <Link href={link}>
      <div
        className={`text-center p-3 rounded-xl shadow-md transition-transform transform hover:scale-105 hover:shadow-lg cursor-pointer border border-gray-200 ${bgColor}`}
      >
