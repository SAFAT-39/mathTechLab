        ...
        <div className="grid grid-cols-1 gap-2">
          {category.items.map((item: any, index: number) => (
            <Link
              key={index}
              href={item.url}
              className="block py-3 px-4 text-sm text-gray-600 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-all duration-200 font-medium bg-white border border-gray-200 hover:border-purple-200"
              onClick={onItemClick}
            >
              {item.title}
            </Link>
